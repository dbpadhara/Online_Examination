...
<html>
<head>
	<title>Online Examination | Semester</title>
	<?php
...
<body>
	   ...
	   <div class="modal-dialog" role="document">
	     <div class="modal-content">
	       ...
	       <div class="modal-body">
	         <form id="field_form" autocomplete="off">
	         	<input type="hidden" id="field_id" name="id" value=0>
	         	<input type="hidden" name="action" value="addField">
	               <div class="form-group">
		               <label>Field name</label>
		               <input type="text" class="form-control" name="field_name" id="field_name" placeholder="enter Field name">
	               </div>
	                           <div class="">
 ...
 <script src="../assets/js/pg_js/admin/field.js"></script>
